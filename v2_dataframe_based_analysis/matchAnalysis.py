...
def seasonwise_win_type_distribution():
    ...
    plt.savefig("v2_dataframe_based_analysis\\Graphs\\matchAnalysis\\seasonwise_win_type_comparison.png")
    plt.show()
...
def win_margin():
    ...
    plt.tight_layout()
    plt.savefig("v2_dataframe_based_analysis\\Graphs\\matchAnalysis\\win_margin_distribution.png")
    plt.show()
...
def matches_per_venue():
    ...
    plt.tight_layout()
    plt.savefig("v2_dataframe_based_analysis\\Graphs\\matchAnalysis\\matches_per_venue.png")
    plt.show()
...
def wins_per_venue():
    ...
    plt.tight_layout()
    plt.savefig("v2_dataframe_based_analysis\\Graphs\\matchAnalysis\\total_matches_vs_completedmatches.png")
    plt.show()
...
def stacked_bar_venue_vs_team():
    ...
    plt.tight_layout()
    plt.savefig("v2_dataframe_based_analysis\\Graphs\\matchAnalysis\\stacked_bar_venue_vs_team.png")
    plt.show()
