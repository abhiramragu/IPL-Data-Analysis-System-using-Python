...
def Runs_per_player(): 
    ...
    plt.tight_layout()
    plt.savefig("v2_dataframe_based_analysis\\Graphs\\playerAnalysis\\top10_run_scorers.png")
    plt.show()
...
def runs_per_match():
    ...
    plt.tight_layout()
    plt.savefig("v2_dataframe_based_analysis\\Graphs\\playerAnalysis\\top10_run_per_match.png")
    plt.show()
def Balls_per_player():
    ...
    plt.tight_layout()
    plt.savefig("v2_dataframe_based_analysis\\Graphs\\playerAnalysis\\top10_balls_faced.png")
    plt.show()
...
def Avg_per_player():
    ...
    plt.tight_layout()
    plt.savefig("v2_dataframe_based_analysis\\Graphs\\playerAnalysis\\Top10_best_strikers.png")
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig("v2_dataframe_based_analysis\\Graphs\\playerAnalysis\\Top10_runs_vs_strike_rate.png")
    plt.show()
def Boundary_contribution():
    ...
    plt.tight_layout()
    plt.savefig("v2_dataframe_based_analysis\\Graphs\\playerAnalysis\\Top10_players_by_total_boundaries.png")
    plt.show()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("v2_dataframe_based_analysis\\Graphs\\playerAnalysis\\Top10_players_boundary_breakdown.png")
    plt.show()
...
def Season_wise_runs():
    ...
    plt.grid()
    plt.tight_layout()
    plt.savefig("v2_dataframe_based_analysis\\Graphs\\playerAnalysis\\Top10_players_season_wise_runs.png")
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(
        "v2_dataframe_based_analysis\\Graphs\\playerAnalysis\\Season_wise_runs_heatmap.png"
    )
    plt.show()
...
def Season_wise_boundaries():
    ...
    plt.grid()
    plt.tight_layout()
    plt.savefig("v2_dataframe_based_analysis\\Graphs\\playerAnalysis\\Top10_players_season_wise_boundaries.png")
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(
        "v2_dataframe_based_analysis\\Graphs\\playerAnalysis\\Season_wise_boundaries_heatmap.png"
    )
    plt.show()
